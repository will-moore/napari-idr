# -*- coding: utf-8 -*-
#
# napari-idr documentation build configuration file, created by
...
project = u'napari-idr'
copyright = u'2015, William Moore'
author = u'William Moore'
...
man_pages = [
    (master_doc, 'napari-cookiecutterplugin_name', u'napari-idr Documentation',
     [author], 1)
]
